...
export interface CustomSoundModalProps {
    isOpen?: boolean;
    onClose?: () => void;
...
export const CustomSoundModal = ({
    ...
    const [selectorPos, setSelectorPos] = useState(20); // Percentage
    const [isDragging, setIsDragging] = useState(false);
    const containerRef = useRef<HTMLDivElement>(null);

    const selectorWidth = 25; // 15 seconds out of 60 seconds (exemplary)
    ...
    return (
        <div className="modal-overlay">
            <div className="custom-sound-modal">
